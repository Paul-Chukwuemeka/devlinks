...
import { ArrowRight, BarChart3, Layout, Palette, Share2, Smartphone } from "lucide-react";
...
const FeatureCard = ({ icon: Icon, title, description, className = "" }: any) => (
  <div className={`p-6 rounded-2xl bg-surface-secondary border border-border-light hover:border-border-medium transition-colors ${className}`}>
      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-surface-primary/80 backdrop-blur-md border-b border-border-light">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-xl font-extrabold tracking-tight text-text-primary">devlinks</span>
          </Link>
      ...
      <main className="flex-1 pt-32 pb-20 px-6">
        <div className="max-w-7xl mx-auto text-center mb-20">
          ...
          <p className="text-xl text-text-secondary max-w-2xl mx-auto mb-10 animate-slide-in-right">
            Join 25M+ people using DevLinks for their link in bio. One link to help you share everything you create, curate and sell from your Instagram, TikTok, Twitter and other social media profiles.
          </p>
        ...
        <div className="mt-24 max-w-4xl mx-auto bg-surface-tertiary rounded-3xl p-12 border border-border-light text-center">
             <h2 className="text-3xl font-bold mb-6">Built for Developers, Creators, and You.</h2>
             <p className="text-text-secondary text-lg mb-8">Start your journey today and consolidate your digital presence.</p>
             <Link href="/auth/signup" className="text-primary-600 font-bold hover:underline text-lg">Get Started for Free &rarr;</Link>
        </div>
